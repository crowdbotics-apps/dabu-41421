"""
Django settings for dabu_41421 project.
...
WSGI_APPLICATION = 'dabu_41421.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dabu_41421 API",
    "DESCRIPTION": "API documentation for dabu_41421 App",
    "VERSION": "v1",
}
